...
void CheckAllButtons(void) {
      ...
      pressButton2Way(!digitalRead(18), 8, 9, 0);
      //pressButton2Way(!digitalRead(9), 10, 11, 1);
      //pressButton2Way(!digitalRead(A0), 12, 13, 2);
      //pressButton2Way(!digitalRead(A1), 14, 15, 3);

      pressButton3Way(!digitalRead(8), !digitalRead(9), 10, 11, 12 , 1);
      pressButton3Way(!digitalRead(10), !digitalRead(16), 13, 14, 15 , 4);
      pressButton3Way(!digitalRead(14), !digitalRead(15), 16, 17, 18 , 7);
